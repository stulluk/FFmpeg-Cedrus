...
#define FFMPEG_CONFIGURATION "--prefix=/usr --enable-nonfree --enable-gpl --enable-version3 --enable-vdpau --enable-libx264 --enable-libmp3lame --enable-libpulse --enable-libv4l2"
...
#define CC_IDENT "gcc 4.6 (Debian 4.6.3-14)"
...
#define CONFIG_CEDRUS264_ENCODER 1
